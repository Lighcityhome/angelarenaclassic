BUTTINGS = {
	...
	GOLD_GAIN_PERCENTAGE = 250,         -- (default = 100) factor for gold income
	GOLD_PER_MINUTE = 300,               -- (default =  95) passive gold
	RESPAWN_TIME_PERCENTAGE = 70,      -- (default = 100) factor for respawn time
	XP_GAIN_PERCENTAGE = 250,           -- (default = 100) factor for xp income
	...
	XP_PER_MINUTE = 300,                  -- (normal dota = 0) everyone gets passive experience (like the passive gold)
	...
	TIME_UNTIL_AGH_SHARD = 9, 			-- Time until aghanim shard in minutes
	FREE_AGH_SHARD = 1, 				-- Whether the shard is free or not
